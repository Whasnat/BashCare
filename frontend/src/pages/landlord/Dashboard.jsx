    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Welcome to your property management command center.</p>
        </div>
      </div>
      ...
      <div className="stat-grid">
        ...
        <div className="stat-card rose">
          <div className="stat-content">
            ...
            <div className="stat-label">Overdue & Outstanding ({overdue?.count || 0} invoices)</div>
            <div className="stat-change down"><ArrowDownRight size={12} className="inline mr-1"/>Action needed</div>
          </div>
                ...
                {recent_activity?.length > 0 ? recent_activity.map((trx, idx) => (
                  <tr key={idx}>
                    <td>
                      ...
                      <div className="text-xs text-muted">Unit {trx.unit_number}</div>
                    </td>
                  ...
                  <tr>
                    <td colSpan="4" className="text-center text-muted py-8">No recent transactions</td>
                  </tr>
                )}
              </tbody>
            </table>
