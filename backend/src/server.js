...
fastify.register(occupantsRoutes, { prefix: '/api/v1/occupants' });
fastify.register(agreementsRoutes, { prefix: '/api/v1/agreements' });
fastify.register(reservationsRoutes, { prefix: '/api/v1/reservations' });
